<template>
    <div class="hei100 bg">
        ...
        <van-cell-group>
            <h2 class="van-doc-demo-block__title">修改手机号</h2>
            ...
            <van-field
                ...
                placeholder="请输入手机号"
                @click-right-icon="$toast('输入原先的手机号')"
            />

            <van-field v-model="code" type="text" label="验证码" placeholder="请输入验证码">
                <van-button
                    slot="button"
                    size="small"
                    type="primary"
            ...
            <div style="text-align:center;">
                <van-button type="primary" size="normal" class="MyBGColor btncss" @click="check">验证</van-button>
            </div>
        </van-cell-group>
    </div>
</template>
