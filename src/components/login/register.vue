    ...
    <div class="hei100">
        ...
        <section class="van-doc-demo-section demo-field test111">
                    ...
                    <div class="van-cell van-field">
                        <div class="van-cell__value van-cell__value--alone">
                            <div class="van-field__body">
                                <input @blur="phoneGCheck" type="text" placeholder="请输入手机号" class="van-field__control phone" name="phone">
                            </div>
                ...
                <div class="van-cell-group van-hairline--top-bottom">
                    <div class="van-cell van-cell--center van-field">
                        ...
                        <div class="van-cell__value">
                            <div class="van-field__body">
                                <input @blur="YZcheck" type="text" placeholder="请输入短信验证码" name="code" class="van-field__control">
            ...
            <section class="van-doc-demo-block showoff">
                ...
                <div class="van-cell-group van-hairline--top-bottom">
                    <div class="van-cell van-field">
                        <div class="van-cell__value van-cell__value--alone">
                            <div class="van-field__body">
                                <input type="password" placeholder="请输入密码" class="van-field__control" name="password">
                            </div>
            ...
            <section class="van-doc-demo-block showoff">
                <div class="van-cell-group van-hairline--top-bottom">
                    <div class="van-cell van-field">
                        <div class="van-cell__value van-cell__value--alone">
                            <div class="van-field__body">
                                <input type="password" placeholder="请再次确认密码" name="password" class="van-field__control">
                            </div>
                            <div class="van-field__error-message tipp"></div>
                        </div>
                    </div>
                </div>
                <div class="van-cell van-cell--required van-field administratoron">
                    <div class="van-cell__title van-field__label"><span>管理员证明</span></div>
                    <div class="van-cell__value">
                        <div class="van-field__body"><input type="text" placeholder="请填写证明" class="van-field__control" name="evidence">
            ...
            <section style="text-align:center">
                <router-link to="/registersuccess" style="width: 100%;" class="van-button van-button--primary van-button--normal btn_pos btn_sent">
    ...
    export default {
        ...
        beforeRouteLeave(to, from, next) {
            ...
            if (ju) {
                ...
                if (g.user_msg.userInfo.role == "管理员") {
                    let evi = document.getElementsByName("evidence")[0]
                    data.evidence = evi.value;
                }
